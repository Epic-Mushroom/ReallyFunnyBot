...
JOB_RELATED_TERMS_2 = ["job", "indeed.com", "career", "position", "occupation", "role", "gig", "employment", "profession", "livelihood", "trade", "vocation", "posting", "opportunity", "application", "apply", "applying", "applicant", "resume", "cv", "cover letter", "submission", "portal", "upload resume", "screening", "register", "enrollment", "candidate", "hiring", "recruiter", "recruitment", "recruiting", "headhunter", "talent acquisition", "job fair", "opening", "onboarding", "shortlist", "employer", "company", "organization", "firm", "hr", "human resources", "hiring manager", "department", "corporation", "full-time", "part-time", "internship", "consultant", "salary", "stipend", "annual income", "401k", "insurance", "linkedin", "glassdoor", "handshake", "ziprecruiter", "workday", "greenhouse", "apply now"]
ANTI_ROBOT_TERMS = ["clanker", "rust bucket", "wire bucket", "wirebucket", "rustbucket", "tinskin", "clink", "waferhead", "zap monkey", "wireback"]
AI_RESPONSES = [
...
GENERAL_CHANNEL_ID_1 = 1309380397410291715 # bkids 2.0
GENERAL_CHANNEL_ID_2 = 1096685257891250228 # sarten
GENERAL_CHANNEL_ID_3 = 964941621110120541 # test server (i think)
